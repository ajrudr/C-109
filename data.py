...
print("Mean,Median,Mode of height is {},{},{} respictvely ".format(height_mean,height_median,height_mode))
print("Mean,Median,Mode of weight is {},{},{} respictvely ".format(weight_mean,weight_median,weight_mode))
